...
var modalOpenBTN = (0, _jquery2.default)('._modalOpen');
var modalCloseBTN = (0, _jquery2.default)('.modal-close');
var modalContent = (0, _jquery2.default)('.modal-content');
var body = (0, _jquery2.default)('body');
var outerLayer = (0, _jquery2.default)('.outer-layer');

var doResetOnModal = function doResetOnModal(parent) {
  if (parent.length) {
    var firstInitResetItem = (0, _jquery2.default)(parent).find('.resetTarget').clone();
    var firstInitResetItemParent = (0, _jquery2.default)(parent).find('.resetTarget').parent('.video-frame');
    firstInitResetItemParent.html(firstInitResetItem);
  }
};

(0, _jquery2.default)(modalOpenBTN).click(function (e) {
  e.stopPropagation();
  var target = (0, _jquery2.default)(e.target).parents('._modalOpen').attr('data-modal') || (0, _jquery2.default)(e.target).attr('data-modal');

  if (target && target.length) {
    (0, _jquery2.default)(outerLayer).addClass('modalOpen');
    (0, _jquery2.default)(body).addClass('modalOpen');
    (0, _jquery2.default)(target).addClass('open');
  } else {
    console.log('No Target found');
  }
});

(0, _jquery2.default)(modalContent).on('click', function (e) {
  (0, _jquery2.default)(body).removeClass('modalOpen');
  (0, _jquery2.default)(outerLayer).removeClass('modalOpen');
  (0, _jquery2.default)(parent).removeClass('open');
  if ((0, _jquery2.default)(e.target).find('.modal-wrap.open')) {
    doResetOnModal((0, _jquery2.default)(e.target).find('.modal-wrap.open'));
  }
});

(0, _jquery2.default)(modalCloseBTN).on('click', function (e) {
  var parent = (0, _jquery2.default)(e.target).parents('.modal-wrap');
...
var initSlick_slider = function initSlick_slider(classEl) {
  (0, _jquery2.default)(classEl).slick({
    dots: false,
    infinite: false,
    arrows: false,
    slidesToShow: 6,
...
var dottedPattern = (0, _jquery2.default)('.dot-pattern');
...
if (dottedPattern.length) {
  ...
  try {
    for (var _iterator = dottedPattern[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var el = _step.value;

      console.log('aa', (0, _jquery2.default)(el).data());
      (0, _jquery2.default)(el).css((0, _jquery2.default)(el).data());
    }
  } catch (err) {
